            ...
            <div className="resume-box">
                ...
                <ul>
                    <li>
                        ...
                        <p className="school-name">Egyetem</p>
                        <p className="name">Pécs</p>
                        <p className="name">Pécsi Tudományegyetem Műszaki és Informatikai Kar</p>
                    </li>
                    <li>
                        <p className="date">2015-2019</p>
                        <p className="school-name">Középiskola</p>
                        <p className="name">Pécs</p>
                        <p className="name">Széchenyi István Gimnázium</p>
                    </li>

                    <li>
                        <p className="date">2007-2015</p>
                        <p className="school-name">Általános Iskola</p>
                        <p className="name">Pécs</p>
                        <p className="name">Pécsi Tudományegyetem Műszaki és Informatikai Kar</p>
