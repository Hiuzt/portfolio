...
const Reference = () => {
    ...
    const referenceArray = [
        ...
        [   
            ...
            "Kerner Dániel",
            "Portfólió",
            "Egy portfólia amit referencia munka miatt készítettem el, ezen a weboldalon megtudhatnak rólam pár tájékoztató jellegű információt", 
            [
                "CSS", "React", "Redux", "JQuery"
            ], 
        ],        
        ]
    ...
    <div className="reference-container">
        ...
        <div className="content">
            ...
            {referenceArray.map((referenceData, referenceIndex) => (
                <li tabIndex={referenceIndex}>
                    <div className="img-container">
                        <img src={require("../files/websites/" + referenceData[0])} alt='' style={{
